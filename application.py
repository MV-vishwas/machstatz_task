...
@application.route('/question_1/<string:start_time>/<string:end_time>') 
...
@application.route('/question_2/<string:start_time>/<string:end_time>') 
...
@application.route('/question_3/<string:start_time>/<string:end_time>') 
